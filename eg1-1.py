...
def save_fig(fig_id, tight_layout = True):
    img_dir = checkNcreateFolder1(PROJECT_ROOT_DIR, "images")
    save_dir = checkNcreateFolder1(img_dir, CHAPTER_ID)
...
gdp_per_capita = pd.read_csv("./input/gdp_per_capita.csv", thousands=',',
